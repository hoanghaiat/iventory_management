...
#     Click Update Course Button
#     Verify Success Message And Course Update 
#     Wait Until Element Is Visible    ${MANDATORY}

# Elective turns gray after update
...
#     Click Update Course Button 
#     Verify Success Message And Course Update 
#     Wait Until Element Is Visible    ${ELECTIVE}
# Active turns green after update 
#     [Documentation]        TC_CE_09
#     [Tags]                Thu Phuong     Edit Course 
#     Go To Course Page
#     Click First Edit Courses Button
#     Fill Course With Valid Data      Công nghệ thông tin  BL2    block chain   4   Khóa học Block Chain   Mandatory    Completed   CS301 - Cơ sở dữ liệu
...
# Completed turns green after update 
#     [Documentation]        TC_CE_10
#     [Tags]                Thu Phuong     Edit Course 
#     Go To Course Page
#     Click First Edit Courses Button
#     Fill Course With Valid Data      Công nghệ thông tin  BL2    block chain   4   Khóa học Block Chain   Mandatory    Completed   CS301 - Cơ sở dữ liệu
...
# Updating turns yellow after update 
#     [Documentation]        TC_CE_11
#     [Tags]                Thu Phuong     Edit Course 
#     Go To Course Page
#     Click First Edit Courses Button
#     Fill Course With Valid Data      Công nghệ thông tin  BL2    block chain   4   Khóa học Block Chain   Mandatory    Completed   CS301 - Cơ sở dữ liệu
#     Click Update Course Button
#     Verify Success Message And Course Update 
#     Wait Until Element Is Visible    ${UPDATED}
